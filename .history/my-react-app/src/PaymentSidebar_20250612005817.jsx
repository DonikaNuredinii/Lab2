...
const PaymentSidebar = ({
  ...
  const handlePaymentSubmit = async () => {
    if (!firstName || !lastName || !phoneNumber || !email || !cardData.name || !cardData.number || !cardData.expire || !cardData.cvv) {
      toast({
        title: "Please fill all required fields including card details.",
        status: "warning",
        duration: 3000,
        isClosable: true,
      });
            ...
            >
              ...
              >
                <Box flex="1" maxW="600px" fontSize="lg" lineHeight="tall" overflowY="auto" mx="auto">
                  ...
                  <Button width="100%" colorScheme="teal" onClick={handlePaymentSubmit} mb={8} fontSize="1xl">
                    Confirm Payment
                  </Button>
                ...
                <Box flex="1" maxW="420px" bg="gray.50" borderRadius="xl" p={6} boxShadow="md" overflowY="auto" mx="auto" alignSelf="stretch">
                  ...
                  <Flex justify="space-between" px={1} mb={2} fontSize="sm" fontWeight="semibold" color="gray.500">
                    <Box flex="1">Item</Box>
                  ...
                  <Flex justify="space-between" align="center" fontWeight="bold" fontSize="xl" pt={2} borderTop="1px solid #E2E8F0">
                    <Text>Total</Text>
      ...
      <Modal isOpen={showInvoiceModal} onClose={() => {
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <Button mt={6} width="100%" colorScheme="orange" onClick={() => {
              setShowInvoiceModal(false);
              onClose();
            }}>
              Close
