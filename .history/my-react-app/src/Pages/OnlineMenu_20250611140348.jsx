...
import PaymentModal from "../PaymentSidebar";
import {
  Box,
  Text,
  IconButton,
...
const OnlineMenu = () => {
  ...
  const [orderId, setOrderId] = useState(null); // për me ruajt ID e porosisë
const {
  isOpen: isPaymentOpen,
  onOpen: onPaymentOpen,
  onClose: onPaymentClose,
} = useDisclosure(); // kontrollon modalin e pagesës
...
console.log("ORDER RESPONSE:", data); // 💡 këtë shtoje
setOrderId(data.ordersID); // ose data.OrderID nëse emri është me O të madhe
onPaymentOpen();
        // këtë e merr orderId-in nga backend
                  // hap modalin për pagesë
