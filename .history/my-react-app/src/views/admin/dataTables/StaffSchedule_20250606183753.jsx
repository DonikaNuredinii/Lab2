...
const StaffSchedule = () => {
  ...
  return (
    <Box pt={20} px={12} maxW="100%" mx="auto">
      <Text fontSize="3xl" fontWeight="bold" mb={6}>Staff Schedules</Text>

      <Button colorScheme="blue" mb={4} onClick={onOpen}>Add Schedule</Button>
