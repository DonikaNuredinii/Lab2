...
const StaffSchedule = () => {
  ...
  return (
    <Box p={6} pb={20} maxW="1200px" mx="auto">
      ...
      <Collapse in={showForm} animateOpacity>
        <Box p={6} borderWidth="1px" borderRadius="xl" bg="gray.50" mb={8} boxShadow="md">
      ...
      <Box overflowX="auto" borderRadius="lg" boxShadow="base">
