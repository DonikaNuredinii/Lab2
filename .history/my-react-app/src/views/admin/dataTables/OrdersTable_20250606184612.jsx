...
const OrdersTable = () => {
  ...
  return (
    <Card mt="80px" px="25px" mb="24px" maxW="1300px" mx="auto">
      ...
      <Tbody>
        {orders.map((order) => (
          <Tr key={order.ordersID}>
            <Td fontWeight="bold">{order.ordersID}</Td>
            <Td fontWeight="bold">{order.costumerID}</Td>
            <Td fontWeight="bold">{order.totalAmount}€</Td>
            <Td fontWeight="bold">{order.status}</Td>
            <Td fontWeight="bold">{new Date(order.createdAt).toLocaleString()}</Td>
            <Td>
