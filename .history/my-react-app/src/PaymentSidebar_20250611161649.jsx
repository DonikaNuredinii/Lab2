...
const PaymentSidebar = ({ totalAmount, orderId, onClose, cartItems, isOpen }) => {
  ...
  const handlePaymentSubmit = async () => {
    // Kontrollo fushat e detyrueshme
    if (
      !firstName ||
      !lastName ||
      !phoneNumber ||
    ...
    // Kontrollo të dhënat e kartës nëse metoda është Card
    if (method === "Card") {
      if (
        !cardData.name ||
        !cardData.number ||
    ...
    // Përgatit DTO-në për dërgim në backend
    const paymentDto = {
      orderID: orderId,
