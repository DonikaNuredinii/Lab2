...
namespace Lab2_Backend.Migrations
{
    ...
    [Migration("20250611121841_StaffSchedule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lab2_Backend.Model.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("Lab2_Backend.Model.Comment", b =>
                {
            ...
            modelBuilder.Entity("Lab2_Backend.Model.RestaurantHours", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<TimeSpan>("OraHapjes")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("OraMbylljes")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("Lab2_Backend.Model.RestaurantSubcategory", b =>
                {
                    b.Property<int>("RestaurantId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lab2_Backend.Model.Review", b =>
                {
                    b.Property<int>("ReviewID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lab2_Backend.Model.StaffSchedule", b =>
                {
            ...
            modelBuilder.Entity("Lab2_Backend.Model.StaffScheduleTable", b =>
                {
                    ...
                    b.HasKey("StaffScheduleID", "TableID");

                    b.HasIndex("TableID");

                    b.ToTable("StaffScheduleTables");
                });
            ...
            modelBuilder.Entity("Lab2_Backend.Model.Comment", b =>
                {
                    b.HasOne("Lab2_Backend.Model.MenuItems", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemID")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Lab2_Backend.Model.Review", "Review")
                        .WithMany()
            ...
            modelBuilder.Entity("Lab2_Backend.Model.StaffSchedule", b =>
                {
                    b.HasOne("Lab2_Backend.Model.User", "AssignedByUser")
                        .WithMany()
                        .HasForeignKey("AssignedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Lab2_Backend.Model.User", "StaffUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Lab2_Backend.Model.StaffScheduleTable", b =>
                {
                    b.HasOne("Lab2_Backend.Model.StaffSchedule", "StaffSchedule")
                        .WithMany("StaffScheduleTables")
            ...
            modelBuilder.Entity("Lab2_Backend.Model.StaffSchedule", b =>
                {
                    b.Navigation("StaffScheduleTables");
                });
